...
from yolox.evaluators.dota_eval import voc_eval_obb
...
class DOTAOBBDetection(Dataset):
    ...
    def __init__(
        ...
        #     self._imgpath = os.path.join("%s", "JPEGImages-val", "%s.bmp")#add
        # elif image_sets[0][1] == 'test':
        #     self._imgpath = os.path.join("%s", "JPEGImages-test", "%s.bmp")  # add
    ...
    def load_anno(self, index):
        ...
        if os.path.exists(self._annopath % img_id):
            ...
            target = []
            # print('please check the annotations file')
