...
class Trainer:
    ...
    def evaluate_and_save_model(self):
        ...
        self.save_ckpt("last_epoch", ap50_95 > self.best_ap, ap50 > self.best_ap_50)
        self.best_ap = max(self.best_ap, ap50_95)
        self.best_ap_50 = max(self.best_ap_50, ap50)

    def save_ckpt(self, ckpt_name, update_best_ckpt=False, updata_best_50=False):
        if self.rank == 0:
