...
def make_parser():
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        # default='../exps/example/yolox_voc/yolox_s_dota_obb.py',
        default='../exps/example/yolox_voc/yolox_s_hrsc_2016.py',
        type=str,
        help="pls input your expriment description file",
    )
    parser.add_argument("-c", "--ckpt",
                        # default='/media/data/miki/yolox-obb/outputs/yolox_s_dota_obb/best_ckpt_50.pth',
                        default='/media/data/miki/yolox-obb/outputs/yolox_s_hrsc_2016/best_ckpt_50.pth',
